window.onloadFuncs.push(() => {
    create_graph('digital-communities-study/graphs/PunggolBTO.json','#graph1')
    create_graph('digital-communities-study/graphs/PunggolResidential.json','#graph2')
    create_graph('digital-communities-study/graphs/JurongBTO.json','#graph3', 600, 480)
    create_graph('digital-communities-study/graphs/JurongResidential.json','#graph4', 600, 480)
    create_graph('digital-communities-study/graphs/ToaPayohBTO.json','#graph5', 500, 400)
    create_graph('digital-communities-study/graphs/ToaPayohResidential.json','#graph6', 500, 400)
})
